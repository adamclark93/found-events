...
export const SESSION = {
  ...
  timeLabel: '12:30pm to 1:30pm BST',
  startIso: '2026-04-30T12:30:00+01:00',
...
function addToCalendarButton(origin) {
  ...
  const outlookUrl = `https://outlook.office.com/calendar/0/deeplink/compose?path=%2Fcalendar%2Faction%2Fcompose&rru=addevent&startdt=2026-04-30T11%3A30%3A00Z&enddt=2026-04-30T12%3A30%3A00Z&subject=${title}&body=${details}&location=${location}`;
  const googleUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${title}&dates=20260430T113000Z%2F20260430T123000Z&details=${details}&location=${location}`;
  const outlookIcon = `<img src="https://www.google.com/s2/favicons?sz=64&domain=outlook.com" width="16" height="16" alt="" style="vertical-align:middle;margin-right:8px;border:0;display:inline-block;">`;
  const googleIcon = `<img src="https://www.google.com/s2/favicons?sz=64&domain=calendar.google.com" width="16" height="16" alt="" style="vertical-align:middle;margin-right:8px;border:0;display:inline-block;">`;
...
export function buildReminderEmail({ firstName, zoomJoinUrl, origin }) {
  ...
  return {
    subject: `Tomorrow at 12:30pm BST: ${SESSION.title}`,
